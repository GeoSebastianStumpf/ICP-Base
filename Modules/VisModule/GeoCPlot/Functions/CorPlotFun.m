                        ...
                        for j=1:numel(nclasses_)
                            ...
                            if DataIn.Active{k}(j)==true
                             ...
                             %       plot(X(classes(rows2keep)==nclasses,:),Y(classes(rows2keep)==nclasses,:),Symbol{j},'MarkerFaceColor',cmap(j,:),'MarkerSize',SymbolSize(j),'MarkerEdgeColor',cmap(j,:),'MarkerFaceAlpha',MarkerFaceAlpha,'MarkerEdgeAlpha',MarkerEdgeAlpha,'LineWidth',LineWidth);
                                    scatter(X(classes(rows2keep)==nclasses,:),Y(classes(rows2keep,:)==nclasses),SymbolSize(j)*10,Symbol{j},'MarkerFaceColor',cmap(j,:),'MarkerEdgeColor',cmap(j,:),'MarkerEdgeAlpha',MarkerEdgeAlpha,'LineWidth',LineWidth);
                                else
                                    
                                    scatter(X(classes(rows2keep)==nclasses,:),Y(classes(rows2keep,:)==nclasses),SymbolSize(j)*10,Symbol{j},'MarkerFaceColor',cmap(j,:),'MarkerEdgeColor',MarkerEdgeColor,'MarkerFaceAlpha',MarkerFaceAlpha,'MarkerEdgeAlpha',MarkerEdgeAlpha,'LineWidth',LineWidth);
