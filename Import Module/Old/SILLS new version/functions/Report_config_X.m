%Report_Config.m
function [A, UNK,STD, SRM, SMAN, REPORT, reportcfg] = Report_config_X(A, UNK,STD, SRM, SMAN, REPORT);
%
...
% %reportcfg.relsens this needs to be the button name if the GUI is build
