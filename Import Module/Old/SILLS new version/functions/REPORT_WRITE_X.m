%REPORT_WRITE
function [A, UNK,STD, SRM, SMAN, REPORT] = REPORT_WRITE_X(A, UNK,STD, SRM, SMAN, REPORT)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
[A, UNK,STD, SRM, SMAN] = CALC_EVALUATE_X(A, UNK,STD, SRM, SMAN);
...
[A, UNK,STD, SRM, SMAN, REPORT, reportcfg] = Report_config_X(A, UNK,STD, SRM, SMAN, REPORT);
...
if ispc %xlswrite works in windows only
   ...
   %     xlswrite(A.reportfile,REPORT.COMPILED);
        writecell(REPORT.COMPILED,A.reportfile);
